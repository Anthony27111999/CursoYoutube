...
var Context = /*#__PURE__*/function () {
  ...
  /**
   * create.html layout and initialize modules and other resources
   */
...
var WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    value: function wrapBodyInlineWithPara() {
      ...
      /**
       * [workaround] firefox often create.html range on not visible point. so normalize here.
       *  - firefox: |<p>text</p>|
       *  - chrome: <p>|text|</p>
       */
    ...
    /**
     * create.html offsetPath bookmark
     *
     * @param {Node} editable
     */
    ...
    /**
     * create.html offsetPath bookmark base on paragraph
     *
     * @param {Node[]} paras
     */
...
/* harmony default export */ const range = ({
  /**
   * create.html Range Object From arguments or Browser Selection
   *
   * @param {Node} sc - start container
   * @param {Number} so - start offset
   * @param {Node} ec - end container
   ...
   * @method
   *
   * create.html WrappedRange from node
   *
   * @param {Node} node
   * @return {WrappedRange}
   */
  ...
  /**
   * create.html WrappedRange from node after position
   *
   * @param {Node} node
   * @return {WrappedRange}
   */
   ...
   * @method
   *
   * create.html WrappedRange from bookmark
   *
   * @param {Node} editable
   ...
   * @method
   *
   * create.html WrappedRange from paraBookmark
   *
   * @param {Object} bookmark
   * @param {Node[]} paras
   * @return {WrappedRange}
 ...
 * @method createImage
 *
 * create.html `<image>` from url string
 *
 * @param {String} url
...
/**
 * @class Create a virtual table to create.html what actions to do in change.
...
var Table = /*#__PURE__*/function () {
  ...
  Table_createClass(Table, [{
    ...
    */
    ...
    /**
     * create.html empty table element
     *
...
var Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    /**
     * create.html a new range from the list of elements
     *
     ...
     * or create.html a new range at the end of the document
     *
     * @param {WrappedRange} rng
     */
     ...
     * or create.html a new range and return it
     *
     * @return {WrappedRange}
     */
...
var TooltipUI = /*#__PURE__*/function () {
  function TooltipUI($node, options) {
    ...
    this.options = external_jQuery_default().extend({}, {
      ...
      trigger: 'hover focus',
      placement: 'bottom'
    }, options); // create.html tooltip node
