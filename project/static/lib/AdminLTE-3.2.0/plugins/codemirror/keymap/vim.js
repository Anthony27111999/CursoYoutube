...
(function(mod) {
  ...
  var Vim = function() {
    ...
    var vimApi= {
      ...
      // NOTE: This will not create.html mappings to key maps that aren't present
          ...
          for (var i = userKeymap.length - 1; i >= 0; i--) {
            ...
            if (ctx !== mapping.context) {
              if (mapping.context) {
                ...
                // `mapping` applies to all contexts so create.html keymap copies
    ...
    RegisterController.prototype = {
      ...
      // create.html it.  If @name is invalid, return the unnamedRegister.
